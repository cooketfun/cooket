...
V4 graduates at exactly `14,490` net native USDC from an empty-curve gross input of `14,636.363636363636363636`. Settlement converts the principal to exactly `14,490,000,000` canonical ERC-20 USDC base units and pairs it with the unchanged 200 million-token LP allocation, for an expected initial LP value of `28,980` USDC. Canonical USDC and Uniswap V3 dependencies are constructor inputs; no Mainnet addresses are encoded by this phase.
