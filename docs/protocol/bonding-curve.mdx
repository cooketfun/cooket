...
`CooketCurveV4` applies the same rounding and fee rules with a `4,830` native-USDC virtual coordinate and `14,490` graduation coordinate. V3 remains the deployed Arc Testnet curve.
