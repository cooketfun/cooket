...
The inherited graduated sell path remains disabled in this repository. When it is enabled in a later phase, the spender is the configured Uniswap router rather than the curve, and output is native USDC rather than WETH/ETH.
