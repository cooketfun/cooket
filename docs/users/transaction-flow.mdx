...
Each write includes the Cooket ERC-8021 Builder Code data suffix. The suffix attributes the transaction but does not change the original contract call, value, quote, fees, or slippage settings.
