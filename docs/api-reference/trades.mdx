...
The API does not accept trade submissions. Curve and swap writes, when enabled in a later phase, go from a user's wallet to Arc Testnet contracts. Graduated-swap execution remains deferred.
