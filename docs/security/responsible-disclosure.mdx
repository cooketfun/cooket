...
For non-sensitive bugs, use the [Arc repository issue tracker](https://github.com/cooketfun/cooket/issues). Do not open a public issue containing an unpatched vulnerability or secret.
