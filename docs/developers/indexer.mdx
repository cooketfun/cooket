...
The Go indexer is configured only for Arc Testnet. Phase 0 permits idle mode
only: non-idle modes fail closed because the inherited event, ETH reserve,
WETH, and Uniswap projection semantics have not been migrated.
