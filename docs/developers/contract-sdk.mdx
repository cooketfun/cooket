...
The package still contains Base Sepolia definitions for legacy tooling and tests, but the Arc web explicitly rejects any configured chain other than Arc Testnet (`5042002`).
