...
description: "Build against Cooket contracts and indexed data."
---

Cooket separates authoritative execution from query-oriented application data.

| Need | Integration surface |
| --- | --- |
| Launch, quote, trade, balances, allowances | Arc Testnet contracts via viem or another EVM client |
