...
describe("transaction foundation", () => {
  ...
  it("validates metadata and image constraints", () => {
    const valid = { name: "Cooket", symbol: "ZK", description: "A token", websiteUrl: "https://cooket.fun", xUrl: "https://x.com/cooket", telegramUrl: "https://t.me/cooket", discordUrl: "https://discord.gg/cooket", imageFile: new File(["ok"], "token.png", { type: "image/png" }), imageUrl: "", imageSource: "file" as const, devBuyEth: "" };
    ...
    expect(validateCreateToken({ ...valid, devBuyEth: "0.1" }).devBuyEth).toMatch(/disabled.*Arc native-USDC/i);
  });
});
