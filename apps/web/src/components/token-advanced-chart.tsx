...
export function TokenAdvancedChart(props: { tokenAddress: string; initialSupply?: string; realtimeEvents?: readonly RealtimeTrade[]; onIndexedThroughBlock?: (block: number | undefined) => void; className?: string }) {
