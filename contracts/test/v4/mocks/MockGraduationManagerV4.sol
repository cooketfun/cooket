...
import {GraduationManagerV4Boundary} from "../../../src/v4/GraduationManagerV4Boundary.sol";

contract MockGraduationManagerV4 is GraduationManagerV4Boundary {
    ...
    constructor(address uniswapV3Factory_, address canonicalUsdc_)
        GraduationManagerV4Boundary(uniswapV3Factory_, canonicalUsdc_, msg.sender)
    {}
