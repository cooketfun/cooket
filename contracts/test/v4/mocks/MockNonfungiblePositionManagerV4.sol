...
contract MockNonfungiblePositionManagerV4 {
    struct Position {
        address token0;
        address token1;
        uint24 fee;
    ...
    bool public collectReentrySucceeded;
    bytes public collectReentryResult;
        ...
        returns (uint256 amount0, uint256 amount1)
    {
        ...
        if (collectReentryTarget != address(0)) {
            (collectReentrySucceeded, collectReentryResult) = collectReentryTarget.call(collectReentryData);
        }
