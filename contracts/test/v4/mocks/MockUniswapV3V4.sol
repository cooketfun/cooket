...
contract MockUniswapV3PoolV4 is IUniswapV3PoolMinimal {
    ...
    contract MockConfiguredUniswapV3PoolV4 is IUniswapV3PoolMinimal {
        ...
        contract MockUniswapV3FactoryV4 is IUniswapV3FactoryMinimal {
            ...
            function createPool(address tokenA, address tokenB, uint24 fee) external override returns (address pool) {
                ...
                pool = address(new MockUniswapV3PoolV4(token0, token1, fee, 200));
                _pools[key] = pool;
            }
