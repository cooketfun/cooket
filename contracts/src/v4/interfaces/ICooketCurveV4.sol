...
import {IFeeManagerV4} from "./IFeeManagerV4.sol";
import {IGraduationManagerV4} from "./IGraduationManagerV4.sol";

interface ICooketCurveV4 {
    struct FeeSplit {
        uint256 totalFee;
        uint256 creatorFee;
        uint256 protocolFee;
    ...
    function feeManager() external view returns (IFeeManagerV4);
    function graduationManager() external view returns (IGraduationManagerV4);
