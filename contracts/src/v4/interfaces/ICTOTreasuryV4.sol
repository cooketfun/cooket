...
interface ICTOTreasuryV4 {
    ...
    event CTOConfirmationSubmitted(bytes32 indexed proposalId, address indexed controller, address indexed treasury);
    ...
    function confirmCTO(bytes32 proposalId) external;
