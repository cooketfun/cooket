...
/// @notice One-token endpoint-cp-v4 shifted constant-product curve.
...
contract CooketCurveV4 is ICooketCurveV4, ReentrancyGuard {
    ...
    uint256 public constant VIRTUAL_TOKEN_RESERVE = EndpointConstantsV4.VIRTUAL_TOKEN_RESERVE;
    uint256 public constant VIRTUAL_NATIVE_USDC_RESERVE = EndpointConstantsV4.VIRTUAL_NATIVE_USDC_RESERVE;
    uint256 public constant GRADUATION_NATIVE_USDC_RESERVE = EndpointConstantsV4.GRADUATION_NATIVE_USDC_RESERVE;
    uint256 public constant K = EndpointConstantsV4.K;
    uint256 public constant FEE_DENOMINATOR = EndpointConstantsV4.FEE_DENOMINATOR;
    uint256 public constant TOTAL_FEE_BPS = EndpointConstantsV4.TOTAL_FEE_BPS;
    uint256 public constant INITIAL_NATIVE_USDC_PRICE = EndpointConstantsV4.INITIAL_NATIVE_USDC_PRICE;
    uint256 public constant TERMINAL_NATIVE_USDC_PRICE = EndpointConstantsV4.TERMINAL_NATIVE_USDC_PRICE;
    uint256 public constant EXACT_GRADUATION_GROSS_NATIVE_USDC = EndpointConstantsV4.EXACT_GRADUATION_GROSS_NATIVE_USDC;
    ...
    function spotPrice() public view override returns (uint256) {
        return Math.mulDiv(
            virtualNativeUsdcReserve(), EndpointConstantsV4.TOKEN_UNIT, virtualTokenReserve(), Math.Rounding.Ceil
        );
    }
    ...
    function grossRequiredForNet(uint256 netAmount) public pure override returns (uint256 gross) {
        ...
        uint256 feeAdjustment = (netAmount - 1) / EndpointConstantsV4.NET_GROSS_ADJUSTMENT_DENOMINATOR;
    ...
    function splitFee(uint256 grossAmount) public pure override returns (FeeSplit memory fees) {
        ...
        fees.creatorFee = Math.mulDiv(
            fees.totalFee, EndpointConstantsV4.CREATOR_FEE_PERCENT, EndpointConstantsV4.FEE_SPLIT_DENOMINATOR
        );
        fees.communityFee = Math.mulDiv(
            fees.totalFee, EndpointConstantsV4.COMMUNITY_FEE_PERCENT, EndpointConstantsV4.FEE_SPLIT_DENOMINATOR
        );
        fees.traderRewardsFee = Math.mulDiv(
            fees.totalFee, EndpointConstantsV4.TRADER_REWARDS_FEE_PERCENT, EndpointConstantsV4.FEE_SPLIT_DENOMINATOR
        );
